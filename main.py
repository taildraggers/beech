"""Scrape Beechcraft listings from Barnstormers.com and render them into
...
PAGE_TITLE = "Other Beechcraft Ads on the Web"
...
EXTERNAL_SEARCH_LINKS = [
    (
        "Trade-A-Plane",
        "https://www.trade-a-plane.com/filtered/search?s-type=aircraft&s-keyword-search=beechcraft&s-original-search=beechcraft",
    ),
    ("Controller", "https://www.controller.com/listings?keywords=beechcraft"),
    ("ASO", "https://aso.com/search?q=Beechcraft"),
]
...
<body>
  ...
  <div class="more-resources">
    <h2>Search More Beechcraft Listings</h2>
    <p>View additional Beechcraft Aircraft listings at these fine sites:</p>
